...
function displayResults(data) {
  ...
  if (paginatedResults.length === 0) {
    ...
    paginatedResults.forEach((item, index) => {
      ...
      // Menambahkan kelas animasi khusus untuk
...
function loadData() {
  const fileUrls = [
    "https://docs.google.com/spreadsheets/d/1gh1w5igTFoZYfJuq221gli7c2CnD62EQ04Ht10RdVe0/export?format=csv&gid=0#gid=0",
    "https://docs.google.com/spreadsheets/d/1gh1w5igTFoZYfJuq221gli7c2CnD62EQ04Ht10RdVe0/export?format=csv&gid=1318822009#gid=1318822009",
  ];
